...
class UserProfileUpdateTest extends TestCase
{
    ...
    public function test_user_can_update_profile()
    {
        ...
        $response = $this->actingAs($user)->post('/mypage/profile', ['name' => '更新後ユーザー名', 'postal_code' => '987-6543', 'address' => '大阪府大阪市', 'building' => '更新ビル', 'image' => $file]);
        $response->assertStatus(302);
        $this->assertDatabaseHas('profiles', ['user_id' => $user->id, 'postal_code' => '987-6543']);
    }
}
